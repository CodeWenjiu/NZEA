...
set HDL_DIR    [expr {[info exists env(HDL_DIR)] ? $env(HDL_DIR) : "build/core/$PLATFORM/riscv32i/sta"}]
set SYNTH_DIR  [expr {[info exists env(SYNTH_DIR)] ? $env(SYNTH_DIR) : "build/core/$PLATFORM/riscv32i/sta/synth"}]
