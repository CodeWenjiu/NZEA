# icsprout55 PDK config. Uses PDK_PATH (from flake) or PROJ_HOME/pdk/icsprout55
if {[info exists env(PDK_PATH)]} {
  set FOUNDARY_PATH $env(PDK_PATH)
} elseif {[info exists PROJ_HOME]} {
  set FOUNDARY_PATH "$PROJ_HOME/pdk/icsprout55"
} else {
  set SCRIPT_DIR [file dirname [info script]]
  set FOUNDARY_PATH "[file dirname $SCRIPT_DIR]/../pdk/icsprout55"
}
