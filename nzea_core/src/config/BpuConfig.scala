...
/** Branch-prediction unit configuration: PHT/BTB sizing and RAS depth.
  * Carried as `CoreConfig.bpu` and read by the fetch-side predictors
  * (IFU/PHT/BTB/RAS) and their update paths (BRU). No defaults here: the CLI
  * entry layer must provide concrete values at every construction site.
  */
